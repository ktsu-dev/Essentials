...
namespace ktsu.Essentials.HashProviders.XxHash3;

using ktsu.Essentials;
using System;
using System.IO;
using SysXxHash3 = System.IO.Hashing.XxHash3;

/// <summary>
/// A hash provider that uses xxHash3 for hashing data.
/// </summary>
public class XxHash3HashProvider : IHashProvider
{
	/// <summary>
	/// The length of the xxHash3 hash in bytes (8 bytes / 64 bits).
	/// </summary>
	public int HashLengthBytes => 8;

	/// <summary>
	/// Tries to hash the specified data into the provided hash buffer using xxHash3.
	/// </summary>
	...
	/// <summary>
	/// Tries to hash the specified data from a stream into the provided hash buffer using xxHash3.
	/// </summary>
	...
	/// <inheritdoc/>
	public IIncrementalHash CreateIncremental() => new NonCryptoIncrementalHash(new SysXxHash3(), HashLengthBytes);
}

...
/// <summary>
/// Dependency injection registration for the user data directory persistence provider.
/// </summary>
public static class ServiceCollectionExtensions
{
	/// <summary>
	/// Registers the user data directory persistence provider for a specific key type.
	/// </summary>
	/// <remarks>
	...
	public static IServiceCollection AddDataHomePersistenceProvider<TKey>(
		...
		where TKey : notnull
	{
		...
		services.TryAddSingleton<IPersistenceProvider<TKey>>(sp => new DataHomePersistenceProvider<TKey>(

...
/// </summary>
public class SHA512HashProvider : IHashProvider, IDisposable
{
	...
	/// </summary>
	public SHA512HashProvider() => _sha512 = new(System.Security.Cryptography.SHA512.Create);
	...
	/// <summary>
	/// Releases the unmanaged resources used by the <see cref="SHA512HashProvider"/> instance and optionally releases the managed resources.
	/// </summary>
	...
	/// <summary>
	/// Releases all resources used by the <see cref="SHA512HashProvider"/> instance.
	/// </summary>
	public void Dispose()
	{

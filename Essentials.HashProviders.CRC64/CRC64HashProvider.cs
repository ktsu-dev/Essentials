...
/// </summary>
public class CRC64HashProvider : IHashProvider
{
	/// <summary>
	...
	public bool TryHash(ReadOnlySpan<byte> data, Span<byte> destination, out int bytesWritten)
	{
		...
		try
		{
			return Crc64.TryHash(data, destination, out bytesWritten)
	...
	/// <inheritdoc/>
	public IIncrementalHash CreateIncremental() => new NonCryptoIncrementalHash(new Crc64(), HashLengthBytes);
}

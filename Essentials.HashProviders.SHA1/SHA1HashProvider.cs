...
/// </summary>
public class SHA1HashProvider : IHashProvider, IDisposable
{
	...
	/// </summary>
	public SHA1HashProvider() => _sha1 = new(System.Security.Cryptography.SHA1.Create);
	...
	/// <summary>
	/// Releases the unmanaged resources used by the <see cref="SHA1HashProvider"/> instance and optionally releases the managed resources.
	/// </summary>
	...
	/// <summary>
	/// Releases all resources used by the <see cref="SHA1HashProvider"/> instance.
	/// </summary>
	public void Dispose()
	{

...
/// <summary>
/// Dependency injection registration for the SHA-1 hashing provider.
/// </summary>
public static class ServiceCollectionExtensions
{
	/// <summary>
	/// Registers the SHA-1 hashing provider.
	/// </summary>
	/// <remarks>
	...
	public static IServiceCollection AddSHA1HashProvider(this IServiceCollection services)
	{
		Ensure.NotNull(services);

		services.TryAddSingleton<SHA1HashProvider>();
		services.TryAddEnumerable(ServiceDescriptor.Singleton<IHashProvider, SHA1HashProvider>());
		return services;
	}
}

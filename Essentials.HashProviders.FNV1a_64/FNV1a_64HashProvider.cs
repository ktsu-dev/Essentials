...
namespace ktsu.Essentials.HashProviders.FNV1a_64;
...
/// <summary>
/// A hash provider that uses FNV-1a 64-bit for hashing data.
/// </summary>
public class FNV1a_64HashProvider : IHashProvider
{
	private const ulong FnvOffsetBasis64 = 0xcbf29ce484222325;
	private const ulong FnvPrime64 = 0x00000100000001b3;

	/// <summary>
	/// The length of the FNV-1a 64-bit hash in bytes (8 bytes / 64 bits).
	/// </summary>
	public int HashLengthBytes => 8;

	/// <summary>
	/// Tries to hash the specified data into the provided hash buffer using FNV-1a 64-bit.
	/// </summary>
	...
	/// <summary>
	/// Tries to hash the specified data from a stream into the provided hash buffer using FNV-1a 64-bit.
	/// </summary>
